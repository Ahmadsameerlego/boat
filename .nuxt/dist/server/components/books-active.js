...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/books/active.vue?vue&type=template&id=f91bf4b8&


var activevue_type_template_id_f91bf4b8_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
  ...
  }), _vm._v(" "), _c('p', [_vm._v(" " + _vm._s(_vm.$t('noBooks')) + "  ")])], 1)], 2) : _vm.provider ? _vm._ssrNode("<section>", "</section>", [_vm.shownOrders.length > 0 ? _vm._ssrNode("<div class=\"row\">", "</div>", _vm._l(_vm.shownOrders, function (order) {
    return _vm._ssrNode("<div class=\"col-lg-4 col-md-6 col-12 mb-3\">", "</div>", [_vm._ssrNode("<div class=\"order-box\">", "</div>", [_vm._ssrNode("<div class=\"order-time\">" + _vm._ssrEscape(" " + _vm._s(order.created_at) + " ") + "</div> <div class=\"img-order-cont mb-2\"><img" + _vm._ssrAttr("src", order.image) + " alt></div> <div class=\"order-name mt-2\">" + _vm._ssrEscape("\n              " + _vm._s(order.user_name) + " \n            ") + "</div> <div class=\"order-num\">" + _vm._ssrEscape(_vm._s(_vm.$t('order_num')) + " :") + "<span>" + _vm._ssrEscape("#" + _vm._s(order.id)) + "</span></div> <div class=\"order-case mt-2 mb-2\"><div class=\"or-flex\"><i class=\"fa-solid fa-drum-steelpan\"></i> <div class=\"or-text\">" + _vm._ssrEscape(_vm._s(_vm.$t('status')) + ":") + "</div></div> <span class=\"color-main\">" + _vm._ssrEscape(" " + _vm._s(_vm.$t('active_status')) + " ") + "</span></div> "), _c('nuxt-link', {
      staticClass: "main-btn up mt-4 mb-3",
      attrs: {
  ...
  }), _vm._ssrNode(" <p>" + _vm._ssrEscape(" " + _vm._s(_vm.$t('noBooks')) + " ") + "</p>")], 2)]) : _vm._e()], 2)]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/books/active.vue?vue&type=template&id=f91bf4b8&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/books/active.vue?vue&type=script&lang=js&
// import axios from '@nuxtjs/axios'
/* harmony default export */ var activevue_type_script_lang_js_ = ({
  data() {
    return {
  ...
  async fetch() {
    if (this.provider == true) {
      try {
        const [res1, res2, res3] = await Promise.all([this.$axios.$get('/delegate-orders?status=inprogress', {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`
          }
...
// CONCATENATED MODULE: ./components/books/active.vue?vue&type=script&lang=js&
 /* harmony default export */ var books_activevue_type_script_lang_js_ = (activevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./components/books/active.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  books_activevue_type_script_lang_js_,
  activevue_type_template_id_f91bf4b8_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
//# sourceMappingURL=books-active.js.map
...
var providerActivevue_type_template_id_503c863e_render = function render() {
  ...
  })], 1), _vm._ssrNode(" <div class=\"dont-have\">" + _vm._ssrEscape("\n                   " + _vm._s(_vm.$t('didNotReceiveCode')) + "\n\n                    ") + "<button type=\"button\" class=\"resent-btn\">" + _vm._ssrEscape("\n                          " + _vm._s(_vm.$t('resendCode')) + "\n                    ") + "</button></div> <div class=\"mt-4\"><button id=\"formsub\"" + _vm._ssrAttr("disabled", _vm.disabled) + " class=\"main-btn up mb-2\">" + _vm._ssrEscape("\n                       " + _vm._s(_vm.$t('certain')) + "\n                        \n                        ") + (_vm.disabled ? "<div role=\"status\" class=\"spinner-border\"></div>" : "<!---->") + "</button></div>")], 2)])], 2)])])])])], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/providerActive.vue?vue&type=template&id=503c863e&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/providerActive.vue?vue&type=script&lang=js&
/* harmony default export */ var providerActivevue_type_script_lang_js_ = ({
  data() {
    return {
  ...
  mounted() {
    ...
    // if( localStorage.getItem('providerActived') == 'true' ){
    ...
    async sendOtp() {
      ...
      await this.$axios.$post('/account/activation', fd, {
        ...
        if (res.key == 'success') {
          ...
          localStorage.setItem('providerActived', true);
        } else {
...
// CONCATENATED MODULE: ./pages/providerActive.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_providerActivevue_type_script_lang_js_ = (providerActivevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/providerActive.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_providerActivevue_type_script_lang_js_,
  providerActivevue_type_template_id_503c863e_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
/* harmony default export */ var providerActive = __webpack_exports__["default"] = (component.exports);

/***/ })

};;
//# sourceMappingURL=providerActive.js.map
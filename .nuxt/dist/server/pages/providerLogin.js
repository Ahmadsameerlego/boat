...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/providerLogin.vue?vue&type=template&id=0bc430b2&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('section', [_vm._ssrNode("<div class=\"img-background\"><img" + _vm._ssrAttr("src", _vm.bg) + " alt></div> "), _vm._ssrNode("<div class=\"login\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"col-md-6 col-12 margin-auto p-0\">", "</div>", [_vm._ssrNode("<form>", "</form>", [_vm._ssrNode("<div class=\"login-box mt-3\">", "</div>", [_vm._ssrNode("<div class=\"login-img text-center mt-2\"><img" + _vm._ssrAttr("src", _vm.src) + " alt></div> <div class=\"title-login text-center mt-3\">" + _vm._ssrEscape(_vm._s(_vm.$t('logIn')) + " ") + "</div> <div class=\"under-title mb-3 text-center mt-2\">" + _vm._ssrEscape("\n              " + _vm._s(_vm.$t('fillData')) + "\n            ") + "</div> "), _vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-md-9 col-12 margin-auto\">", "</div>", [_vm._ssrNode("<div class=\"mb-3 main-inp-cont\">", "</div>", [_vm._ssrNode("<h6 class=\"fontBold mainColor font14 font600\">" + _vm._ssrEscape(_vm._s(_vm.$t('phoneNumber')) + " ") + "</h6> "), _vm._ssrNode("<div class=\"relative-co\">", "</div>", [_vm._ssrNode("<input type=\"tel\" id=\"telephone\"" + _vm._ssrAttr("placeholder", _vm.$t('fillPhoneNumber')) + " name=\"phone\"" + _vm._ssrAttr("value", _vm.phone) + " class=\"inp-spe-tele\" style=\"direction:rtl\"> "), _vm._ssrNode("<div class=\"icon-float\">", "</div>", [_c('font-awesome-icon', {
    attrs: {
  ...
  }) + "</div>" : "<!---->") + "</div>")], 2)], 2), _vm._ssrNode(" <div class=\"mt-4\"><button" + _vm._ssrAttr("disabled", _vm.disabled) + " class=\"main-btn up mb-2\">" + _vm._ssrEscape("\n                        " + _vm._s(_vm.$t('logIn')) + "\n                        ") + (_vm.disabled ? "<div role=\"status\" class=\"spinner-border\"></div>" : "<!---->") + "</button></div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"dont-have\">", "</div>", [_vm._ssrNode(_vm._ssrEscape("\n               " + _vm._s(_vm.$t('noAccount')))), _c('nuxt-link', {
    attrs: {
      "to": "/providerRegister"
    }
  }, [_vm._v(" / " + _vm._s(_vm.$t('newLogIn')) + "  ")])], 2), _vm._ssrNode(" <div class=\"forget-login mb-4\"><button type=\"button\" class=\"decore-me font14 color-main\">" + _vm._ssrEscape(_vm._s(_vm.$t('visitorLogin')) + " ") + "</button></div>")], 2)])])])])], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/providerLogin.vue?vue&type=template&id=0bc430b2&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/providerLogin.vue?vue&type=script&lang=js&
/* harmony default export */ var providerLoginvue_type_script_lang_js_ = ({
  // // middleware : ['auth'] ,
  data() {
    return {
...
// CONCATENATED MODULE: ./pages/providerLogin.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_providerLoginvue_type_script_lang_js_ = (providerLoginvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/providerLogin.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_providerLoginvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var providerLogin = __webpack_exports__["default"] = (component.exports);

/***/ })

};;
//# sourceMappingURL=providerLogin.js.map
      ...
      <div class="">
        ...
        <form ref="regForm" @submit.prevent="register">
          <div class="">
            ...
            <div class="title-login text-center mt-3"> {{ $t('newBoat') }} </div>
              ...
              <div class="col-md-9 col-12 margin-auto">
                ...
                <div class="mb-3 main-inp-cont">
                  ...
                  <div class="relative-co">
                    <input
                      type="text"
                      :placeholder="$t('pleasefillBoatNameEN')"
                      class="inp-spe-tele"
                      name="name_en"
                      v-model="name_en"
                    />
                    ...
                    <div class="position-relative w-100">
                      ...
                      >
                        ...
                        <ul class="list-group" v-else>
                          <li class="list-group-item">لا تتوفر مدينة</li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="mb-3 main-inp-cont">
                  ...
                  <div class="relative-co">
                    <textarea
                      ...
                      id=""
                      class="main-textarea"
                      :placeholder="$t('explaindescripeBoatAr')"
                      rows="3"
                    ></textarea>
                    <div class="icon-float">
                ...
                <div class="mb-3 main-inp-cont">
                  ...
                  <div class="relative-co">
                    <textarea
                      ...
                      id=""
                      class="main-textarea"
                      :placeholder="$t('explaindescripeBoatEn')"
                      rows="3"
                    ></textarea>
                    <div class="icon-float">
                      <font-awesome-icon :icon="['fas', 'note-sticky']" />
                ...
                <div class="photo-permition mb-3">
                  ...
                  <div class="flex-upload-imgs">
                    <label
                      for="filesNext_input"
                      class="upload-main position-relative"
                    >
                      <input
                      ...
                      <font-awesome-icon
                        ...
                        style="color: #111b5a; font-size: 22px"
                      />
                        ...
                        <div class="hidden-img d-flex" style="flex-wrap: wrap">
                          ...
                          >
                            ...
                            <img class="preview img-thumbnail" :ref="'image'" />
                                                      ...
                                                      <!-- <input hidden type="file" name="certificates[]" accept="image/*" > -->
                ...
                <div class="photo-permition mb-3">
                  <h6 class="font-bold">
                    ...
                    <p> {{ $t('imageLength') }} {{ boat_image_count }} {{ $t('image') }} </p>

                  </h6>
                  <div class="flex-upload-imgs">
                    <label
                      for="filesNext2_input"
                      class="upload-main position-relative"
                    >
                      <input
                    ...
                    <div class="img-upload-show mt-4">
                      <div class="d-flex">
                        <div class="hidden-img d-flex" style="flex-wrap: wrap">
                          <div
                            class="position-relative"
                            v-for="(image, key) in adsImages2"
                            :key="key"
                          >
                            <button
                              class="remove-img text-white"
                              type="button"
                              @click="removeImage2(image, key)"
                            >
                              &times;
                            </button>
                            <img
                              ...
                              :ref="'image1'"
                            />
                            <!-- <input hidden type="file" name="boatImages[]" accept="image/*" > -->
                          </div>
                        </div>
                      </div>
                    </div>

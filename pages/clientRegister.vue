            ...
            <div class="login-box mt-3">
              ...
              <div class="row">
                <div class="col-md-9 col-12 margin-auto">
                  ...
                  <div class="mb-3 main-inp-cont">
                    <h6 class="fontBold mainColor font14 font600">{{ $t('country') }}</h6>
                    <div class="relative-co">
              ...
              <div class="dont-have">
                ...
                {{  $t('haveAccount') }}
                <nuxt-link to="clientLogin"> {{  $t('logIn') }}</nuxt-link>
              </div>

              <div class="forget-login mb-4">
                <nuxt-link to="/client/HomePage" class="decore-me font14 color-main"
                  > {{  $t('visitorLogin') }}</nuxt-link
                >
              </div>
